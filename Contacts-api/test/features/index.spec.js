...
const router = require(path.join(appRoot, 'src/interfaces/http/routers'))(logger); /* eslint-disable-line global-require */
...
describe('Contact API Tester', function () {
  ...
  require('./routes/entriesRoutes')(server.express, chai, expect);
  require('./routes/namesRoutes')(server.express, chai, expect);
